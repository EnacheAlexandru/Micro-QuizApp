        ...
        <div>
          ...
          {isLoading ? (
            ...
            <div className="m-5 flex flex-wrap justify-evenly gap-4">
              {myQuestionsList.map((item) => (
                <React.Fragment key={item.id}>
                    <div className="block w-96 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
                        ...
                        <div className="font-normal text-gray-700 dark:text-gray-400" style={{fontSize: '13px'}}>Last modified: {DateFormatter.format(item.creation)}</div>
              ...
              <div className="font-bold text-2xl flex justify-center">You did not add any questions!</div>
            )
          }
        </div>
      );
